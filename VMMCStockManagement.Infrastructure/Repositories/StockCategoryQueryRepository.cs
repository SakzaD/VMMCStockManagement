...
{
	public class StockCategoryQueryRepository : QueryRepository<Category, CategoryFilter>,
		IQueryRepository<Category, CategoryFilter>
	{
		public StockCategoryQueryRepository(VMMCStockManagementDbContext context) : base(context)
		{
		}
