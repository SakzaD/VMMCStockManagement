...
{
	public class CategoryQueryService : BaseQueryService<CategoryFilter, Category>, ICategoryQueryService
	{

		public CategoryQueryService(IQueryRepository<Category, CategoryFilter> queryRepository,
